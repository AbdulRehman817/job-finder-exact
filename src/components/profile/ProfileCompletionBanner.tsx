...
const ProfileCompletionBanner = ({
  ...
  const message =
    type === "employer"
      ? "Complete your recruiter and company profile to start posting jobs"
      : "Complete your profile to apply for jobs";

  return (
    <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 md:p-6 mb-6 dark:bg-amber-900/30 dark:border-amber-800">
      <div className="flex flex-col md:flex-row md:items-center gap-4">
        <div className="flex items-start gap-3 flex-1">
          ...
          <div className="flex-1">
            <h4 className="font-semibold text-amber-800 mb-1 dark:text-amber-200">Profile Incomplete</h4>
            ...
            {missingFields.length > 0 && (
              <p className="text-xs text-amber-600 mt-2 dark:text-amber-200">
